...
import ViasatStickerTable from "../components/ViasatStickerTable";
...
const CreateViasatStickers = () => {
  ...
  const [data, setData] = useState<
    { depotPin: number; masterPin: number; serialNumber: string; userPin: number }[] | null
  >(null);
  ...
  return (
    <>
      <div className="create-viasat-stickers">
        <Typography variant="h1" align="center" gutterBottom className="no-print">
        ...
        >
          ...
          <CardActions>
            ...
            {data && (
              <Button variant="contained" onClick={printStickers}>
                Print
              </Button>
            )}
          </CardActions>
